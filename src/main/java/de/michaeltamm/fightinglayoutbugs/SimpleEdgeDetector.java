 ...
 * @author Michael Tamm
 */
public class SimpleEdgeDetector extends AbstractDetector implements EdgeDetector {
    ...
    public boolean[][] detectVerticalEdgesIn(FirefoxDriver driver, int minLength) throws Exception {
        ...
        try {
            // Hide all text ...
            driver.executeScript("jQuery('*').css('color', 'transparent');");
            // Take screenshot ...
            final int[][] pixels = takeScreenshot(driver);
